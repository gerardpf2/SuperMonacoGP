...
#define CURRENT_VELOCITY_POSITION_X (int)(0.895f * WINDOW_WIDTH)
#define CURRENT_VELOCITY_POSITION_Y (int)(0.925f * WINDOW_HEIGHT)
#define CURRENT_VELOCITY_POSITION WindowPosition{ CURRENT_VELOCITY_POSITION_X, CURRENT_VELOCITY_POSITION_Y }

#define KMH_RECT_X (int)(0.9f * WINDOW_WIDTH)
#define KMH_RECT_Y (int)(0.85f * WINDOW_HEIGHT)
...
#define CURRENT_LAP_TIME_POSITION_Y (int)(0.3275f * WINDOW_HEIGHT)
