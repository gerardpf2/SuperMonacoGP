...
#define CAR_MAX_VELOCITY 50.0f
#define CAR_ACCELERATION_ROAD 10.0f
#define CAR_DEACCELERATION_ROAD 10.0f
#define CAR_DEACCELERATION_FRICTION_ROAD 0.0f
#define CAR_DEACCELERATION_FRICTION_GRASS 15.0f
...
#define CAR_MIN_X (1.5f * ROAD_MIN_X)
#define CAR_MAX_X (1.5f * ROAD_MAX_X)

#define CAR_ACCELERATION_GRASS (0.5f * CAR_ACCELERATION_ROAD)
#define CAR_DEACCELERATION_GRASS (1.5f * CAR_DEACCELERATION_ROAD)
#define CAR_DEACCELERATION_FRICTION_LIMIT_VELOCITY (0.333 * CAR_MAX_VELOCITY)
